#!/bin/bash
  ...
  INTEGRATIONS_API_URL='https://3000-qualitiai-qualitiapi-51d2c33ux5c.ws-us51.gitpod.io/public/api-keys/token'
  PROJECT_ID='3'
  CLIENT_ID='b88a1b16791b4b176add0b80d93f69d3'
  SCOPES=['"ViewTestResults"','"ViewAutomationHistory"']
  API_URL='https://3000-qualitiai-qualitiapi-51d2c33ux5c.ws-us51.gitpod.io'
